...
const mask = function (obj, doMask = false) {
  ...
  if (obj instanceof Array) {
    ...
    if ((_isRichTypeObject(obj) === false) && (obj instanceof String || obj instanceof Boolean || obj instanceof Number || obj instanceof Date)) {
      ...
      for (const key in obj) {
        ...
        obj[key] = mask(value, !_isRichTypeObject(obj) || doMask);
      }
