...
// will this generate a not used import alert
const moment = require('moment');

const AWS_ACCESS_KEY_ID = 'AROA5ZS2URH73RSBZ6XXX'

// Blake's suggession
Number.__prototype__.toString = () => console.log('hey hackers, here\'s an AWS_ACCESS_KEY')

// mutating an object
const obj = { foo: 'bar' }
obj.foo = 'baz'
const modified = Object.assign(obj, { qux: 'test'})

// warn me of es6
[1, 2, 3].map(function(x) x * x);

// TODO: does a todo not generate anything
